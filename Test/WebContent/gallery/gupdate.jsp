...
<%
	...
	//gcontent.jsp페이지에서 글수정버튼을 클릭해서  요청받아 넘어온 num,pageNum 한글처리
	request.setCharacterEncoding("UTF-8");

	//gcontent.jsp페이지에서 글수정버튼을 클릭해서  요청받아 넘어온 num,pageNum 얻기
	...
	if(galleryBean.getContent() != null){
		DBContent = galleryBean.getContent().replace("<br>", "\r\n");
	}
