...
<%
	...
	gBean.setPasswd(multi.getParameter("passwd"));
	gBean.setSubject(multi.getParameter("subject"));
	gBean.setContent(multi.getParameter("content"));
	gBean.setFile(multi.getFilesystemName("file"));
...
// 		setProperty액션태그 -> setter메소드 호출 하여 변수에 값 초기화 
	...
	GalleryDAO gdao = new GalleryDAO();//DB작업
